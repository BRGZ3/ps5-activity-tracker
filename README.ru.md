...
Текущий публичный релиз: **1.1.0**.

Публичный tag релиза — `v1.1.0`. В PKG сохранены монотонные внутренние
метаданные установщика (`01.049.000`), чтобы он устанавливался поверх
